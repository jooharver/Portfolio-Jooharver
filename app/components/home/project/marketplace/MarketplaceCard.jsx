...
import { Search, Store, Play, ShoppingCart } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="absolute top-[5%] md:top-[10%] right-[2%] md:-right-[2%] z-20 flex items-center gap-2 bg-[#18181b]/80 border border-[#9B7E5D]/50 px-3 md:px-4 py-2 rounded-full shadow-[0_0_20px_rgba(155,126,93,0.4)] backdrop-blur-md group-hover:opacity-0 transition-opacity duration-300"
      >
        <Store size={16} className="text-[#9B7E5D]" />
        <span className="text-[10px] md:text-xs font-semibold text-white tracking-wide">Role Switching</span>
      </motion.div>

      <motion.div 
        animate={{ y: [0, 10, 0] }}
        transition={{ repeat: Infinity, duration: 4, ease: "easeInOut", delay: 1 }}
        className="absolute bottom-[10%] md:bottom-[15%] left-[5%] md:left-[2%] z-20 flex items-center gap-2 bg-[#18181b]/80 border border-[#4A7559]/50 px-3 md:px-4 py-2 rounded-full shadow-[0_0_20px_rgba(74,117,89,0.4)] backdrop-blur-md group-hover:opacity-0 transition-opacity duration-300"
      >
        <ShoppingCart size={16} className="text-[#4A7559]" />
        <span className="text-[10px] md:text-xs font-semibold text-white tracking-wide">Zustand Cart State</span>
      </motion.div>

      <motion.div 
        animate={{ y: [0, -8, 0] }}
        transition={{ repeat: Infinity, duration: 3.5, ease: "easeInOut", delay: 0.5 }}
        className="absolute bottom-[20%] md:bottom-[30%] right-[5%] md:right-[2%] z-20 flex items-center gap-2 bg-[#18181b]/80 border border-white/30 px-3 md:px-4 py-2 rounded-full shadow-xl backdrop-blur-md group-hover:opacity-0 transition-opacity duration-300"
      >
        <Search size={16} className="text-white" />
        <span className="text-[10px] md:text-xs font-semibold text-white tracking-wide">Debounce Search</span>
      </motion.div>
