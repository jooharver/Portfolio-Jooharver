  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="absolute top-[10%] right-[5%] md:right-[5%] z-20 flex items-center gap-2 bg-[#18181b]/80 border border-emerald-500/50 px-3 md:px-4 py-2 rounded-full shadow-[0_0_20px_rgba(16,185,129,0.4)] backdrop-blur-md group-hover:opacity-0 transition-opacity duration-300"
      >
