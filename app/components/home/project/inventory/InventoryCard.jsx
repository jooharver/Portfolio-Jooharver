...
export default function InventoryCard({ onClick }) {
  return (
    ...
    >
      ...
      {/* 2. FLOATING PROMOTIONAL BADGES - Posisi ditarik ke dalam agar aman */}
      <motion.div 
        animate={{ y: [0, -10, 0] }}
        transition={{ repeat: Infinity, duration: 3, ease: "easeInOut" }}
        className="absolute top-[5%] md:top-[10%] right-[5%] md:right-[5%] z-20 flex items-center gap-2 bg-[#18181b]/80 border border-[#b300ff]/50 px-3 md:px-4 py-2 rounded-full shadow-[0_0_20px_rgba(179,0,255,0.4)] backdrop-blur-md group-hover:opacity-0 transition-opacity duration-300"
      >
        <Database size={16} className="text-[#b300ff]" />
        <span className="text-[10px] md:text-xs font-semibold text-white tracking-wide">Stock Management</span>
      </motion.div>

      <motion.div 
        animate={{ y: [0, 10, 0] }}
        transition={{ repeat: Infinity, duration: 4, ease: "easeInOut", delay: 1 }}
        className="absolute bottom-[10%] md:bottom-[15%] left-[5%] md:left-[5%] z-20 flex items-center gap-2 bg-[#18181b]/80 border border-white/30 px-3 md:px-4 py-2 rounded-full shadow-xl backdrop-blur-md group-hover:opacity-0 transition-opacity duration-300"
      >
      ...
      <motion.div 
        ...
        className="absolute bottom-[20%] md:bottom-[30%] right-[5%] md:right-[5%] z-20 flex items-center gap-2 bg-[#18181b]/80 border border-[#ffa67a]/50 px-3 md:px-4 py-2 rounded-full shadow-[0_0_20px_rgba(255,166,122,0.4)] backdrop-blur-md group-hover:opacity-0 transition-opacity duration-300"
      >
